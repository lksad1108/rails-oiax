class Customer::SessionsController < Customer::Base
  ...
  private def login_form_params
    # params.requrei(:customer_login_form).permit(:email, :password)
    params.requrei(:customer_login_form).permit(:email, :password, :remember_me)
  end

  def destroy
    cookies.delete(:customer_id)
    sessiom.delete(:customer_id)
